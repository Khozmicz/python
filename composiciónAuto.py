class Automovil:
    ...
    def get_info_auto(self):
        #retorna información al auto
        return (f"Modelo:{self.modelo}" ,f"Marca:{self.marca}" ,f"Color: {self.color}", self.motor.get_info_motor())
...
class Motor:
    ...
    def get_info_motor(self):
        return f"Cilindrada: {self.cilindros}"
